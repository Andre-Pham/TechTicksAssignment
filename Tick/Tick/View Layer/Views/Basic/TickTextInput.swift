...
class TickTextInput: TickUIView {
    ...
    override init() {
        ...
        self.setFont(to: TickFont(font: TickFonts.Poppins.Medium, size: 18))
        self.setTextColor(to: TickColors.textDark1)
        self.setBackgroundColor(to: TickColors.secondaryComponentFill)
        self.setCornerRadius(to: TickDimensions.foregroundCornerRadius)
        self.setHeightConstraint(to: TickDimensions.textInputHeight)
